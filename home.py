...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        widget=QWidget()
        widget.setStyleSheet("background:teal")
        layout_horizontal=QHBoxLayout()
        menu_vertical_layout=QVBoxLayout()

        self.btn_home=QPushButton("Home")
        self.btn_add = QPushButton("Add Vaccine")
        self.btn_manage = QPushButton("Manage Vaccine")
        self.btn_history = QPushButton("Manage Records")

        menu_vertical_layout.setContentsMargins(0,0,0,0)
        menu_vertical_layout.setSpacing(0)
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:teal;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showHistory(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:teal;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showManage(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:teal;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def showAdd(self):
        self.btn_home.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet("width:200px;height:160px;font-size:20px;background:teal;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_manage.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
        self.btn_history.setStyleSheet("width:200px;height:160px;font-size:20px;background:mediumaquamarine;color:#fff;font-weight:bold;border:1px solid white")
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3]==1:
                label.setStyleSheet("background-color:seagreen;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color:grey;color:white;padding:5px;width:100px;height:100px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addAddStudentPage(self):
        ...
        name_label.setStyleSheet("color:aqua;padding:8px 0px;font-size:20px")
        
        contact_label=QLabel("Contact : ")
        contact_label.setStyleSheet("color:aqua;padding:8px 0px;font-size:20px")
        
        age_label=QLabel("Age : ")
        age_label.setStyleSheet("color:aqua;padding:8px 0px;font-size:20px")
        
        vaccine_type=QLabel("Vaccine Type : ")
        vaccine_type.setStyleSheet("color:aqua;padding:8px 0px;font-size:20px")
        
        error_label=QLabel("")
        error_label.setStyleSheet("color:aqua;padding:12px 10px;font-size:20px")

        name_input=QLineEdit()
        name_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px")
        
        contact_input=QLineEdit()
        contact_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px")
        
        age_input=QLineEdit()
        age_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px")

        vaccine_input=QLineEdit()
        vaccine_input.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px")
        
        vtype=QComboBox()
        vtype.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;border:1px solid white")
        vtype.addItem("Covishield")
        vtype.addItem("Covaxine")
        vtype.addItem("Select")

        button=QPushButton("Add Vaccine")
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:navy;border:1px solid white")
        ...
        # # layout.addWidget(vaccinetype_label)
        # # layout.addWidget(vaccinetype_input)
        layout.addWidget(vaccine_type)
        ...
        button.clicked.connect(lambda:self.addVaccine(name_input.text(),contact_input.text(),age_input.text(),vtype.currentIndex(),error_label))
        self.vertical_2.addWidget(frame)

    def addVaccine(self,name,contact,age,index,error_label):
        vtp='Covishield'
        if index==0:
            vtp='Covishield'
        else:
        ...
        data=self.dbOperation.addVaccine(name,contact,age,str(vtp))
        if data==True:
            error_label.setText("                          Vaccine Slot Booked Successfully")
        elif data==False:
            error_label.setText("Failed to Book Vaccine Slot !")
        else:
    ...
    def addManagePage(self):
        data=self.dbOperation.getCurrentvaccine()
        self.table=QTableWidget()
        self.table.setStyleSheet("background:azure")
        ...
        self.table.setHorizontalHeaderItem(3,QTableWidgetItem("CONTACT"))
        self.table.setHorizontalHeaderItem(4,QTableWidgetItem("VACCINE TYPE"))
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:navy;border:1px solid white")
    ...
    def refreshHistory(self):
        ...
        data=self.dbOperation.getAllvaccine()
        loop=0
    ...
    def addHistoryPage(self):
        ...
        self.table1.setRowCount(len(data))
        self.table1.setStyleSheet("background:azure")
        self.table1.setColumnCount(7)
        ...
        self.table1.setHorizontalHeaderItem(2,QTableWidgetItem("AGE"))
        self.table1.setHorizontalHeaderItem(3,QTableWidgetItem("CONTACT"))
        self.table1.setHorizontalHeaderItem(4,QTableWidgetItem("Vaccine TYPE"))
    ...
    def exitCall(self):
        ...
        if btton:
            ...
            self.dbOperation.exitvaccine(id)
